...
export default function EditUser(props) {
  ...
  const editUser = (id) => {
    ...
    fetch(
      ...
      if (res.ok) {
        console.log('Modification effectuée avec succée')
        // const payload = {
        //   identifier,
        //   password,
        // };
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      >
                      <input type="text" defaultValue={props?.user?.username} className="bg-transparent"/>
                      ...
                      <div className="mt-5 flex flex-col gap-3">
                        ...
                        <p className="text-sm text-gray-700 grid grid-cols-2 ">
                          ...
                          <input
                            type="text"
                            defaultValue={props?.user?.created_at.slice(0,10)}
                            disabled
